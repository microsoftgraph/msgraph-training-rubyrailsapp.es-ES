...
1. Seleccione **registro nuevo**. En la página **registrar una aplicación** , establezca los valores de la siguiente manera.
    ...
    - Establezca **el nombre** en `Ruby Graph Tutorial`.
    ...
    - En **URI**de redireccionamiento, establezca la primera lista desplegable para `Web` y establezca el `http://localhost:3000/auth/microsoft_graph_auth/callback`valor en.
